...
#' @param pkg_path Path to the package source directory or the installed
#'   package.
#' @param is_installed Logical indicating whether the package is installed
#'   (`TRUE`) or a source package (`FALSE`).
