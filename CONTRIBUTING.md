...
This outlines how to propose a change to rdocdump. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("e-kotov/rdocdump", fork = TRUE)`.
...
Please note that the rdocdump project is released with a [Contributor
Code of Conduct](https://www.ekotov.pro/rdocdump/CODE_OF_CONDUCT.md). By
